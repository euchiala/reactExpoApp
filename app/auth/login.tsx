...
import Navtop from '../../component/nav/NavTop'
...
import RemenberComponent from '../../component/inputContainer/RemenberComponent'
import Divider from '../../component/divider/Divider'
import LabelComponent from '../../component/inputContainer/LabelComponent'
...
const login = () => {
    ...
    const Inputs: Input[] = [{
        ...
        icon: <Svg style={styles.vectorEmail} width="18" height="14" viewBox="0 0 18 14" fill="none" >
    ...
    return (
        <View>
            ...
            <View style={styles.formWrapper}>
                {Inputs.map && Inputs.map((input: Input, index: number) => (
                    <InputContainer
                        key={index}
                        input={input}
                        value={input.type === 'email-address' ? email : password}
                        onChangeText={input.type === 'email-address' ? handleEmailChange : handlePasswordChange}
                    />
                ))}
            ...
            <View style={styles.rowProviders}>
                {providers.map && providers.map((provider: Provider, index: number) => (
            ...
            <View style={styles.ctasignupwrapper}>
                ...
                <Text style={styles.linksignup} onPress={() => handleRedirect("/auth/signup")}>
                    {`Sign up`}
                </Text>
            </View>
        </View>
